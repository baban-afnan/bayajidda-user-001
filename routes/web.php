...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('profile')->group(function () {
            ...
            Route::post('/verify-pin', [EducationalController::class , 'verifyPin'])->name('verify.pin');
     ...
     */
        ...
        Route::prefix('tv')->group(function () {
            Route::get('/', [CableController::class , 'index'])->name('tv');
            Route::post('/verify', [CableController::class , 'verifyIuc'])->name('verify.iuc');
            Route::post('/buy', [CableController::class , 'purchase'])->name('buy.cable');
            Route::get('/get-variations', [CableController::class , 'getVariations'])->name('tv.variations');
        }
        );
