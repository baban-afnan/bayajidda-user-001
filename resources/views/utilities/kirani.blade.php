<x-app-layout>
    <title>Baya Jidda - Buy Kirani Minutes</title>
            ...
            <div class="card custom-card shadow-sm border-0">
                <div class="card-header justify-content-between bg-primary text-white rounded-top">
                    <div class="card-title fw-semibold">
                        <i class="bi bi-phone me-2"></i> Buy Kirani Minutes
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <!-- Kirani Form -->
                    <form id="buyKiraniForm" method="POST" action="{{ route('kirani.buy') }}">
                        @csrf

                        <!-- Phone Number -->
                        <div class="mb-3">
                            <label for="mobileno" class="form-label fw-semibold">Kirani Phone Number</label>
                        ...
                        <!-- Submit Button -->
                        <div class="d-grid">
                            <button type="button" id="buy-kirani" class="btn btn-primary btn-lg fw-semibold">
     ...
     @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                const buyButton = document.getElementById('buy-kirani');
                const confirmButton = document.getElementById('confirmPinBtn');
                const form = document.getElementById('buyKiraniForm');
